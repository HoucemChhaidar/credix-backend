...
@SecurityRequirement(name = "Bearer Authentication") public class WalletController {
	 ...
	 */
	@PostMapping @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Create wallet", description = "Create a new wallet for a user. Only corporate users can create wallets for their employees.")
	@ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Wallet created successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "400", description = "Wallet already exists or validation error", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "User not found")})
	 ...
	 */
	@GetMapping("/user/{userId}") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Get wallet by user ID", description = "Retrieve wallet information for a specific user by their ID. Only corporate users can access employee wallets.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Wallet retrieved successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "Wallet not found for the specified user")})
	 ...
	 */
	@GetMapping("/my-wallet") @PreAuthorize("hasAnyRole('USER', 'VENDOR', 'ADMIN')")
	 ...
	 */
	@GetMapping("/corporate") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Get corporate wallets", description = "Retrieve all wallets managed by the authenticated corporate user.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Wallets retrieved successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required")})
	 ...
	 */
	@PostMapping("/add-credit") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Add credit to wallet", description = "Add credit to a user's wallet. Only corporate users can add credit to their employees' wallets.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Credit added successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "400", description = "Invalid request or validation error"), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "Wallet not found")})
	 ...
	 */
	@GetMapping("/balance/{userId}") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Get user balance", description = "Get wallet balance for a specific user by their ID. Only corporate users can check employee balances.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Balance retrieved successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "Wallet not found")})
	 ...
	 */
	@GetMapping("/my-balance") @PreAuthorize("hasAnyRole('USER', 'VENDOR', 'ADMIN')")
	 ...
	 */
	@PostMapping("/deduct/{userId}") @PreAuthorize("hasAnyRole('VENDOR', 'ADMIN')")
	@Operation(summary = "Deduct credit", description = "Deduct credit from a user's wallet for payment processing. Available to vendors and admins.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Credit deducted successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "400", description = "Insufficient balance or invalid amount"), @ApiResponse(responseCode = "403", description = "Access denied - Vendor or Admin role required"), @ApiResponse(responseCode = "404", description = "Wallet not found")})
	 ...
	 */
	@PutMapping("/toggle-status/{userId}") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Toggle wallet status", description = "Activate or deactivate a user's wallet. Only corporate users can manage wallet status.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Wallet status updated successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "400", description = "Invalid request"), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "Wallet not found")})
	public ResponseEntity<ResponseWrapper<WalletResponse>> toggleWalletStatus(
			...
			@RequestParam @Parameter(description = "New wallet status", example = "true") Boolean isActive,
			Authentication authentication
	) {
		try {
			String corporateEmail = authentication.getName();
	 ...
	 */
	@GetMapping("/active") @PreAuthorize("hasRole('ADMIN')")
	@Operation(summary = "Get all active wallets", description = "Retrieve all active wallets in the system. Only administrators can access this endpoint.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Active wallets retrieved successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "403", description = "Access denied - Admin role required")})
	 ...
	 */
	@PostMapping("/transfer") @PreAuthorize("hasRole('CORPORATE')")
	@Operation(summary = "Transfer credit between wallets", description = "Transfer credit from one user's wallet to another within the same corporate organization.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Credit transferred successfully", content = @Content(schema = @Schema(implementation = ResponseWrapper.class))), @ApiResponse(responseCode = "400", description = "Insufficient balance or invalid transfer"), @ApiResponse(responseCode = "403", description = "Access denied - Corporate role required"), @ApiResponse(responseCode = "404", description = "One or both wallets not found")})
